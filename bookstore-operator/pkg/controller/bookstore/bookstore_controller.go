...
import (
	...
	blogv1alpha1 "github.com/example-inc/bookstore-operator/pkg/apis/blog/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner BookStore
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &blogv1alpha1.BookStore{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileBookStore) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set BookStore instance as the owner and controller
...
func newPodForCR(cr *blogv1alpha1.BookStore) *corev1.Pod {
